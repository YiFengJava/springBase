package spring.study.securitycore.social.qq.config;
...
@Configuration
@ConditionalOnProperty(prefix = "mysecurity.socialProperties.qqProperties",name = "app-id")
public class QQAutoconfig extends SocialConfigurerAdapter {
    ...
    public ConnectionFactory<?> createConnectionFactory() {
        QQProperties qq = securityProperties.getSocialProperties().getQqProperties();
