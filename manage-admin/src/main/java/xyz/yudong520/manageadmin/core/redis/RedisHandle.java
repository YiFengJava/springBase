...
import xyz.yudong520.manageadmin.core.redis.init.RedisCommand;
...
public class RedisHandle implements RedisCommand<String, Object> {
    ...
    @Override
    public Set<TypedTuple<Object>> getZSetReverseRangeWithScores(String key, long start, long end) {
        return redisTemplate.boundZSetOps(key).reverseRangeWithScores(start, end);
    }

    @Override
    public Set<TypedTuple<Object>> getZSetRangeWithScores(String key) {
        return getZSetRangeWithScores(key, 0, getZSetSize(key));
    }

    @Override
    public Set<TypedTuple<Object>> getZSetReverseRangeWithScores(String key) {
